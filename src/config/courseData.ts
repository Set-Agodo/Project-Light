...
export const MODULES: LetterModule[] = [
  ...
  makeModule('I', 'Infinite', 'God is Infinite: He has no limits.',
    ...
    ['📏', '🏔️', '🍦'],
    [{ word: 'Igloo', emoji: '🏔️', isCorrect: true }, { word: 'Dog', emoji: '🐕', isCorrect: false }, { word: 'Ball', emoji: '🏀', isCorrect: false }],
    'Igloo', 'Island', '🏔️', '🏝️', true,
    ['i', 'l', 'j', 't'], 'i',
  ...
  makeModule('X', 'Excellent', 'God is Excellent: He is above all.',
    ...
    ['🦴', '📦', '🪓', '😄'],
    [{ word: 'X-Ray', emoji: '🦴', isCorrect: true }, { word: 'Dog', emoji: '🐕', isCorrect: false }, { word: 'Bird', emoji: '🐦', isCorrect: false }],
    'X-Ray', 'Excited', '🦴', '😄', true,
    ['x', 'k', 'z', 'y'], 'x',
